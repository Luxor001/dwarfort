...
L'agente \textit{forger} predispone tutta una serie di beliefs utili per una gestione di alto livello della miniera.\\\\
Il bisogno corrente di materiale è esplicitato dal belief \textit{needs(Material)}
